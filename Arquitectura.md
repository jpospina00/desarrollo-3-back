...
| **US-9** |Como cliente, quiero poder completar un formulario de compra ingresando mis datos de entrega y método de pago, para finalizar mi compra.                                                                                  | - El usuario debe ingresar su dirección de entrega y seleccionar un método de pago. <br>- Si los datos son correctos, la orden se genera y se muestra un resumen de compra. <br>- Si falta algún dato obligatorio, se muestra un mensaje de error.                                                                                                                                                                                                                                                                |
