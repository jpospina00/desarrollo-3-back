...
| **US-02** | Como administrador, quiero gestionar los pedidos de mis clientes para verificar de que se realicen correctamente.                 | - El administrador debe poder visualizar todos los pedidos en un panel de control.<br>- Debe existir la opción de cambiar el estado de un pedido (Pendiente, En proceso, Enviado, Entregado, Cancelado).<br>- El sistema debe actualizar el estado del pedido en tiempo real.<br> - Se debe enviar una notificación al cliente cuando el estado de su pedido cambie.|                                                                         | _[Agregar criterios de aceptación]_                                                                                                                                                                                                                                                                                    |
...
| **US-04** | Como cliente, quiero poder realizar la consulta dl estado de mi pedido en tiempo real para saber cuándo llegará.                  | - El cliente debe ver el estado actual de su pedido desde su lista de pedidos. <br> - Si el pedido fue realizado, debe mostrar un rango de tiempo en el cual llegará. <br> - El sistema debe permitir actualizaciones sobre el estado del pedido. <br> - Si el pedido es entregado, debe aparecer una confirmación.|                                                                                                                                                                                                                                                               |
| **US-05** | Como administrador, quiero gestionar los usuarios del sistema para controlar el acceso y los permisos.                            | - El administrador debe poder ver la lista de usuarios registrados. <br> - Debe poder asignar roles (Cliente, Repartidor, Administrador). <br> - Debe poder eliminar cuentas si es necesario. |
>  **Instrucciones:**  
