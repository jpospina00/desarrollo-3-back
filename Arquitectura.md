...
| **RQ-05** | Cliente | Se solicita consultar la ruta de entrega en tiempo real  | Módulo de entregas | El servicio está operando en condiciones normales | El sistema debe proporcionar la ruta de entrega en tiempo real, actualizando la información cada 40 segundos. | La latencia de actualización de la ruta, no debe superar los 500ms y la precisión debe ser mínimo del 85% |
...
| **RQ-07** | Administrador | Se solicita garantizar la entrega de mensajes | RabbitMQ | El sistema detecta un mensaje fallido o no procesado correctamente | El mensaje debe reenviarse 
